...
# F17 (0903) — root agent 工具裁剪白名单
# root agent 只给编排+报告类工具，不给 scanner/browser/shell 类
ROOT_TOOLS_WHITELIST = {
    "spawn_agent", "wait_for_agents", "send_message_to_agent",
    "create_vulnerability_report", "amend_threat_model",
    "save_threat_model", "record_coverage", "finish_scan",
    "phase_complete", "sitemap_add_feature", "sitemap_set_business",
