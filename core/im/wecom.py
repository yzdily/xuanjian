"""core.im.wecom — 企业微信群机器人 connector（中期 M3）。"""
...
class WecomConnector(IMConnector):
    ...
    def __init__(self, webhook_url: str | None = None):
        self.webhook = webhook_url or os.environ.get("XUANJIAN_WECOM_WEBHOOK", "")

    def send(self, target: str, content: str, *, card: dict | None = None) -> dict:
        if not self.webhook:
            return {"status": "skipped", "error": "XUANJIAN_WECOM_WEBHOOK 未设置"}
