...
from ._fp_filters import (
    ...
    # §2.7 WAF 厂商归因（_is_waf_block_page 命中时产出）
    identify_waf_from_response,
    last_waf_attribution,
    active_business_deny_patterns,
)
...
__all__ = [
    ...
    "_verify_sensitive_path_content",
    # §2.7 WAF 厂商归因辅助
    "identify_waf_from_response", "last_waf_attribution",
    # 业务码配置驱动（§4 Phase 2 item 7）
    "active_business_deny_patterns",
    # 常量
